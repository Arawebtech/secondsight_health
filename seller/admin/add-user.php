...
if (isset($_POST['submit']) and $_POST['submit'] == 'Save') {
	...
	if (!empty($appl_univrep1)) {
		$appl_univrep1s = rand(1000, 9999) . "_" . preg_replace("/[^a-zA-Z0-9.-]/", "_", trim($appl_univrep1));
	...
	if (!empty($thumbnail_image_name)) {
		$thumbnail_image_s = rand(1000, 9999) . "_" . preg_replace("/[^a-zA-Z0-9.-]/", "_", trim($thumbnail_image_name));
			...
			foreach ($_POST['yt_links'] as $key => $yt_link) {
				if (!empty(trim($yt_link))) {
					...
					if (!empty($_FILES['yt_thumbs']['name'][$key])) {
						$thumb_name = rand(1000, 9999) . "_" . preg_replace("/[^a-zA-Z0-9.-]/", "_", trim($_FILES['yt_thumbs']['name'][$key]));
													...
													<div class="form-group">
														...
														<div class="input-group">
															...
															<?php if (!empty($info_blog->user_image)) { ?>
																<img width="50px"
																	src="../images/user/user/<?php echo rawurlencode($info_blog->user_image); ?>">
															...
															?>
																<div class="col-md-3" style="margin-bottom:15px;">
																	<div style="border:1px solid #ddd; padding:10px; border-radius:5px; background:#f9f9f9; text-align:center;">
																		<img src="../images/user/products/<?php echo rawurlencode(trim($img)); ?>" style="width:100%; height:120px; object-fit:cover; border-radius:4px; margin-bottom:10px;">
																...
																<?php foreach($existing_videos as $vid){ ?>
																	<div class="col-md-3" style="margin-bottom:15px;">
																		<div style="border:1px solid #ddd; padding:10px; border-radius:5px; background:#f9f9f9;">
																			<img src="../images/user/videos/<?php echo rawurlencode($vid->thumbnail_image); ?>" style="width:100%; height:120px; object-fit:cover; border-radius:4px; margin-bottom:10px;">
