...
<div class="dashboard-header text-center">
    <div class="container">
        ...
        <div class="mt-3">
            <a href="<?php echo $base_url; ?>" class="text-white opacity-75 text-decoration-none">Home</a>
                ...
                <div class="order-card">
                    <div class="order-header">
                        <div>
                            ...
                            <span class="fs-5 fw-bold text-dark">#<?php echo $order_id; ?></span>
                        </div>
                        <div class="text-md-end">
                            <span class="text-muted d-block small text-uppercase fw-bold">Total Amount</span>
                            <span class="fs-5 fw-bold" style="color: #fd9800;">₹<?php echo number_format($payment['payable_amount'] ?? 0, 2); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="order-body">
                        ...
                        ?>
                            <div class="item-row d-flex align-items-center gap-4">
                                <img src="<?php echo $base_url; ?>assets/img/product-detail/<?php echo $row['p_image']; ?>" class="item-img" alt="product">
                                <div class="flex-grow-1 text-md-start">
                                    <h6 class="fw-bold mb-1"><?php echo htmlspecialchars($row['p_name']); ?></h6>
                                    <p class="text-muted small mb-0">Qty: <?php echo $row['no_of_item']; ?> | Price: ₹<?php echo number_format($row['p_actual_price'], 2); ?></p>
                                </div>
                                <div class="text-md-end">
                                    <span class="status-badge <?php echo ($order_status == 'Success' || $order_status == 'Delivered') ? 'status-success' : 'status-pending'; ?>">
                                        <?php echo ucfirst($order_status); ?>
                                    </span>
                                    <?php if ($order_status === 'Delivered'): ?>
                                        <div class="mt-2">
                                            <a href="invoice-pdf.php?order_id=<?php echo base64_encode($row['order_id']); ?>" class="btn btn-sm btn-outline-primary" target="_blank"><i class="fas fa-file-invoice me-1"></i>Invoice</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="order-footer">
                        <div class="row align-items-center">
                            <div class="col-md-6 text-md-start">
                                <span class="text-muted d-block small"><i class="far fa-calendar-alt me-1"></i> Order Placed: <b><?php echo $order_date_str; ?></b></span>
                                <span class="text-muted d-block small"><i class="fas fa-wallet me-1"></i> Payment: <b><?php echo ucfirst($payment['payment_method'] ?? 'Online'); ?></b></span>
                            </div>
                            <!-- <div class="col-md-6 text-md-end mt-3 mt-md-0">
                                <a href="order-tracking.php?order_id=<?php echo $order_id; ?>" class="btn btn-sm btn-outline-warning fw-bold px-3">Track Order</a>
                            </div> -->
                        </div>
                    </div>
                </div>
